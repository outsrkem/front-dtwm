    ...
    <el-dialog v-model="dialogVisible" width="1200" title="处理处理">
        ...
        <div style="margin: 12px 0 12px 0">
            <el-descriptions border>
                ...
                <el-descriptions-item label="出库类型">{{ order.classification.name }}</el-descriptions-item>
...
export default {
    ...
    data() {
        return {
            ...
            operations: {
                ...
                APPROVED: [{ action: "execute", text: "出库", type: "primary" }],
    ...
    computed: {
        currentOperations() {
            ...
            // 关键逻辑：如果是当前会话中执行的出库操作，即使状态是EXECUTED也不显示完成按钮
